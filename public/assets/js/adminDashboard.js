...
function salesGraph(val, salesDetails) {
        ...
        salesReport.forEach((val) => {
                ...
                // If the year is not in the yearly object, add it with an initial count of 0
                if (!yearly[year]) {
                        yearly[year] = 0;
                }
        ...
        // console.log('monthly :', monthly, yearCounts,years);

        // console.log('salesDetails :',salesReport)
        if (val === 'monthly') {
