...
function getDeliveryItemsHTML(items) {
    ...
    for (let item of items) {
        data += `
    <div class="table-row">
        <div class=" table-cell w-6/12 text-left font-bold py-1 px-4"></div>
        <div class=" table-cell w-[10%] text-center"></div>
        <div class=" table-cell w-2/12 text-center">₹</div>
        <div class=" table-cell w-2/12 text-center">₹</div>
    </div>
    `;
    }
...
<body>
    <div class="p-10">
        ...
        <div class="flex items-start justify-center">
            ...
            <div class="flex items-end flex-col">
                <div class="pb-16">
                    ...
                    <p class="text-right text-gray-500 text-xl">#  </p>
                </div>
                <div class="flex">
        ...
        <div class=" pt-20 pr-10 text-right">
            <p class="text-gray-400">Total: <span class="pl-24 text-black">₹ </span></p>
        </div>
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const pdf = await page.pdf({
                ...
                ...options.pdfOptions // allows for customization
            });
